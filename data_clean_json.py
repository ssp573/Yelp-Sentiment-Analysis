...
val_data.to_pickle("data/val_not_restuarants_yelp_tokenized_no_stem.pkl")
print("Val data saved at data/val_not_restuarants_yelp_tokenized_no_stem.pkl")

print("Tokenizing training data...")
train_data['text']=train_data['text'].apply(tokenize)
train_data.to_pickle("data/train_not_restuarants_yelp_tokenized_no_stem.pkl")
print("Training data saved at data/train_not_restuarants_yelp_tokenized_no_stem.pkl")

print("Tokenizing test data...")
test_data['text']=test_data['text'].apply(tokenize)
test_data.to_pickle("data/test_not_restuarants_yelp_tokenized.pkl")
print("Training data saved at data/test_not_restuarants_yelp_tokenized.pkl")
