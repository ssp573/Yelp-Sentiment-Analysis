...
for category in categories:
    ...
    train_data=pd.concat([pos_data[:100000],neg_data[:100000]])
    # test_data=pd.concat([pos_data[100000:120000],neg_data[100000:1200000]])
    ...
    train_data.to_pickle("data/train_{}_yelp_tokenized_no_stem.pkl".format(categories))
    print("Train data saved at data/data/train_{}_yelp_tokenized_no_stem.pkl".format(categories))

    # print("Tokenizing test data...")
    # test_data['text']=test_data['text'].apply(tokenize)
    # train_data.to_pickle("data/test_{}_yelp_tokenized_no_stem.pkl".format(categories))
    # print("Train data saved at data/data/test_{}_yelp_tokenized_no_stem.pkl".format(categories))
